OpenHashtableProgram: main.o Node.o DoubleLinkedList.o OpenHashtable.o
	g++ -g -Wall -std=c++11 main.o Node.o DoubleLinkedList.o OpenHashtable.o -o OpenHashtableProgram
